-- Manual Migration: Add Real-Time Fields to Driver Profiles
-- Run this in Supabase SQL Editor
-- Safe: Only adds new columns with defaults

-- Step 1: Add location tracking fields
...
-- Step 2: Add foreign key constraint for current_trip_id
ALTER TABLE public.driver_profiles 
...
AND column_name IN ('last_known_location', 'last_location_update', 'current_trip_id', 'socket_id');
